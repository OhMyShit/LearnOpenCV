...
#define WINDOW_NAME "【滑动条的创建&线性混合示例】"			//为窗口创建宏

const int g_nMaxAlphaValue = 100;
int g_nAlphaValueSlider;
double g_dAlphaValue;
double g_dBeataValue;
...
void on_Trackbar(int, void*)
{
	...
	g_dBeataValue = (1.0 - g_dAlphaValue);

	addWeighted(g_srcImage1, g_dAlphaValue, g_srcImage2, g_dBeataValue,0.0, g_dstImage);
